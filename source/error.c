...
error errors[]={
    ...
    {ERROR_CODE_9, "LABEL NAME IS INVALID, CANNOT BE ASSEMBLY OPERATION NAME"},
    ...
    {ERROR_CODE_34, "THIS OPERATION USE ILLEGAL ADDRESSING METHOD TO THE OPERAND"},
    ...
    {ERROR_CODE_44, "LABEL NAME IS INVALID, CANNOT BE ASSEMBLY INSTRUCTION NAME"}
};
